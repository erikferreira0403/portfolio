   ...
   videoList: MeuObjeto[] = [
    ...
    img: '/../../../assets/img/cadastrousuariosimage.jpg',
     title: 'CRUD Usuários (Full-Stack)',
      description : 'Projeto pessoal Full-Stack, criando uma API utilizando .Net 5, com Front-end em Angular 14, e SQLite como banco de dados, onde tive a ideia de realizar um aplicação que permita um trabalho em equipe, começando pelo gerenciamento de usuários que vão ter acesso a aplicação. '},
